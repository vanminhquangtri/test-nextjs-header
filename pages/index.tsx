export default function Home() {
  return (
    <div>
      ...
      <div>
        <textarea className="bg-black w-full auto-expand-textarea resize-none chat-input flex-1 font-[400] text-[16px] p-6 outline-none text-white caret-[#FF6500] flex items-center"></textarea>
      </div>
    </div>
  );
}
